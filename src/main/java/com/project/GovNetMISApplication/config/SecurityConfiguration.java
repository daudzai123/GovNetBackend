    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/ActivityLog/getDepartmentWise").hasRole("log_view_DepartmentWise")
                        .requestMatchers("/comment/add").hasAnyRole("comment_add", "reply_comment")
                        .requestMatchers("/comment/getAllCommentsBySendDocId").hasRole("comments_view")
                        ...
                        .requestMatchers("/sendDocument/ExpiredDocuments").hasRole("view_expired_document_list")
                        .requestMatchers("/auth/login").permitAll()
                        .requestMatchers("/linking/add").hasRole("add_linked_documents")
                        .requestMatchers("/linking/delete/**").hasRole("delete_linked_documents")
                        .requestMatchers("/document/forlinking").hasRole("add_linked_documents")
                        .requestMatchers("/document/linkings/**").hasRole("view_linked_documents")
                        .requestMatchers("/ActivityLog/all").hasRole("log_view")
                        .requestMatchers("/document/removeAppendantDoc/**").hasRole("delete_append")
                        .requestMatchers("/document/addAppendantDoc/**").hasRole("add_append")
                        .requestMatchers("/sendDocument/getSendDocTree/**").hasRole("view_document_tracking")
